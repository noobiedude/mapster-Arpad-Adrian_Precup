...
public static class TileRenderer
{
    public static BaseShape Tessellate(this MapFeatureData feature, ref BoundingBox boundingBox, ref PriorityQueue<BaseShape, int> shapes)
    {
        ...
        // foreach(var (key, val) in feature.Properties){
        //     Console.WriteLine("In tesselate " + key + " " + val);
        // }
        // test
        var featureType = feature.Type;
        // Console.WriteLine("In tessalate 2 " + featureType);
        ...
        else if (feature.Properties.Any(p => p.Key == PropertyKeys.Water) && feature.Type != GeometryType.Point)
        {
            var coordinates = feature.Coordinates;
